...
OutputBaseFilename=TorrenzBloc_Setup_v{#AppVer}
Compression=lzma2
...
[Run]
Filename: "iexplore.exe"; Parameters: "https://toranverse.neocities.org/Portal/FIRSTINTALLTORRENZBLOC"; Description: TorrenzBloc; Flags: shellexec postinstall nowait skipifsilent
